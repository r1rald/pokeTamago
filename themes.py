...
sg.LOOK_AND_FEEL_TABLE['TamagoDark'] = {'BACKGROUND': '#000066',
                                         'TEXT': '#FFCC66',
                                         'INPUT': '#339966',
                                         'TEXT_INPUT': '#000000',
                                         'SCROLL': '#99CC99',
...
sg.LOOK_AND_FEEL_TABLE['TamagoLight'] = {'BACKGROUND': '#000066',
                                         'TEXT': '#FFCC66',
                                         'INPUT': '#339966',
                                         'TEXT_INPUT': '#000000',
                                         'SCROLL': '#99CC99',
...
def make_window(theme):
    ...
    window = sg.Window('All Elements Demo', layout, right_click_menu=right_click_menu_def, right_click_menu_tearoff=True,
    ...
    while True:
        ...
        if event in (None, 'Exit'):
            ...
            folder_or_file = sg.popup_get_folder(
                'Choose your folder', keep_on_top=True)
